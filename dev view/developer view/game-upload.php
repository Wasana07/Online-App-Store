...
<!-- start of the header -->
    ...
    <div class = "full-form">
        <form method = "POST" action ="game-upload-insert.php" >
            ...
            <br>
                <input type = "text" id ="title" class = "title-box" name="gtitle" placeholder = "Add game title" required>
            <br>
            <br>

            <label for="desc" class="description-text"> Description: </label>
            <br>
                <input type = "text" id="desc" class = "description-box" name="gdescription" placeholder = "Add game description " required>
            <br>
            <br>
            
            <label for = "cate" class = "category-text"> Category: </label>
            <br>
                <input type = "text" id ="cate" class = "category-box" name="gcategory" placeholder = "Add game category" required>
            <br>
            <br>
            
            <label for = "link" class = "link-text"> Link: </label>
            <br>
                <input type = "text" id ="link" class = "link-box" name="glink" placeholder = "Add game link here" required>
            <br>
            <br>
